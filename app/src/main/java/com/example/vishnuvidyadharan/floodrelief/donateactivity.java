    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(donateactivity.this, "Selected"+ itemvalue, Toast.LENGTH_SHORT).show();
            }
        ...
        catagories2.add(0, "donate items");
        ...
        catagories3.add(0, "donate items");
        ...
        catagories4.add(0, "donate items");
        ...
        catagories5.add(0, "donate items");
        ...
        catagories6.add(0, "donate items");
